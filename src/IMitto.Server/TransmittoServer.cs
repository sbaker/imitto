...
public sealed class TransmittoServer : Disposable, IMittoServer
{
	...
	private static Task<TransmittoSocket> AcceptRequest(IMittoServerConnection connection, CancellationToken token)
	{
