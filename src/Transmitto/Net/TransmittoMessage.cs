...
public abstract class TransmittoMessage(TransmittoHeader header) : ITransmittoMessage
{
...
public class TransmittoMessage<TBody> : TransmittoMessage, ITransmittoMessage<TBody> where TBody : TransmittoMessageBody
{
