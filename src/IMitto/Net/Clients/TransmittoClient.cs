...
public class TransmittoClient : IMittoClient
{
	...
	protected async Task StartEventLoopAsync(IMittoClientConnection connection, TransmittoStatus response, CancellationToken token)
	{
